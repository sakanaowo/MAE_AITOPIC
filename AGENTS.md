...
When starting a new feature, identify the project type to use appropriate sections:

| Type | Indicators | Focus Sections |
|------|-----------|----------------|
| **AI/ML** | model, training, dataset, inference | Data Requirements, Model Architecture, Model Evaluation |
| **Web** | frontend, UI, React, Vue, components | UI/UX Requirements, Component Tree, E2E Scenarios |
| **Backend** | API, database, server, microservices | API Contract, Database Schema, Load Testing |
| **Mixed** | combination of above | Use all relevant sections |

## Documentation Structure
- `docs/ai/requirements/` - Problem understanding and requirements (+Data/API/UI sections)
- `docs/ai/design/` - System architecture and design decisions (+Model/DB/Component diagrams)
- `docs/ai/planning/` - Task breakdown and project planning
- `docs/ai/implementation/` - Implementation guides and notes
- `docs/ai/testing/` - Testing strategy and test cases (+Evaluation/Load/E2E)
